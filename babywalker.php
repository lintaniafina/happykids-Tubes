     ...
     <?php include("carousel.php") ?>
        <main class="main" role="main">
            <div class="main-inner wrapper">
                <ul class="product-list ul-reset">
                    <li class="product-item ib">
                        <section class="product-item-inner">
                            <img src="img/img_pr/baby walker.jpeg" alt="">
                            <!-- /.product-item-image -->
                    ...
                    <!-- /.product-item-inner -->
                        ...
                        <section class="product-item-inner">
                            <img src="img/img_pr/baby walker1.jpeg" alt="">
                            <!-- /.product-item-image -->
                            <h1 class="product-item-title">
                                nama barang
                          </h1>
                    ...
                    <!-- /.product-item-inner -->
                        ...
                        <section class="product-item-inner">
                            <img src="img/img_pr/baby walker2.jpeg" alt="">
                            <!-- /.product-item-image -->
                            <h1 class="product-item-title">
                                nama barang
                          </h1>
                    ...
                    <!-- /.product-item-inner -->
                        ...
                        <section class="product-item-inner">
                            <img src="img/img_pr/baby walker3.jpeg" alt="">
                            <!-- /.product-item-image -->
                            <h1 class="product-item-title">
                                nama barang
                          </h1>
                ...
                <li class="product-item ib">
                        <section class="product-item-inner">
                            <img src="img/img_pr/baby walker4.jpeg" alt="">
                            <!-- /.product-item-image -->
                            <h1 class="product-item-title">
                                nama barang
                          </h1>
                ...
                <li class="product-item ib">
                        <section class="product-item-inner">
                            <img src="img/img_pr/baby walker5.jpeg" alt="">
                            <!-- /.product-item-image -->
                            <h1 class="product-item-title">
                                nama barang
                          </h1>
                ...
                <li class="product-item ib">
                        <section class="product-item-inner">
                            <img src="img/img_pr/baby walker6.jpeg" alt="">
                            <!-- /.product-item-image -->
                            <h1 class="product-item-title">
                                nama barang
                          </h1>
